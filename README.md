...
<p>NOTE: Please ensure you download any dependency you might miss and if you're not interested in having debug test version of the bot. You can make both tokens same and both server ids same and the bot should work fine.</p>
<dl>
